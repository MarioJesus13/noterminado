...
@WebServlet(name = "ServletModificarEjercicio", urlPatterns = {"/modificarejericio"})
public class ServletModificarEjercicio extends HttpServlet {
    protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        if (cc.actualizarejercicios(nuevosejercicios)) {
            response.sendRedirect("ejercicios.jsp");
        } else {
            response.sendRedirect("modificar_Ejercicio.jsp?idejercicio=" + id_ejercicio);
        }
    }
